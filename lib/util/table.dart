class TableUtil {
  ...
  static final ddlScripts = {
    '1' : ['CREATE TABLE $teamTable ($cId INTEGER PRIMARY KEY, $cName TEXT NOT NULL, $cMajorMain INTEGER NOT NULL, $cMajorShade INTEGER NOT NULL, $cMinorMain INTEGER NOT NULL, $cMinorShade INTEGER NOT NULL);'],
    '2' : ['CREATE TABLE $memberTable ($cId INTEGER PRIMARY KEY, $cTeam INTEGER NOT NULL, $cName TEXT NOT NULL, $cAge INTEGER NOT NULL, $cRegist INTEGER NOT NULL);'],
  };
}